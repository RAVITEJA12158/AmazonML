...
Run: python scripts/demo_generate_synthetic_data.py

NOTE: this is FAKE data for smoke-testing the code only. It is not written
to data/raw or to the real student_holdout split, and run_all.py no longer
calls this automatically. To smoke test: run this script, then temporarily
set config.yaml paths.raw_dir to "data/demo_raw" and run run_all.py, then
change raw_dir back.
"""
import os
import sys
...
def main():
    ...
    raw_dir = "data/demo_raw"  # never data/raw or the real student_holdout dev/ split -- this is fake data, kept clearly separate
